...
public class IncluirGerenciaRegional {
	...
	public void testAtualizagerenciaregional() throws Exception {
	    ...
	    nome.clear();
		nome.sendKeys("GERÊNCIA REGIONAL DO TESTE");
		Thread.sleep(1000);
	    ...
	    assertTrue(driver.findElement(By.id("resposta_cadastro")).getText().matches("^[\\s\\S]*Gerência Regional cadastrada com sucesso![\\s\\S]*$"));
